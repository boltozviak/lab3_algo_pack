...
- Проходит по массиву, сравнивая соседние элементы и меняя их местами, если они стоят в неправильном порядке. Повторяет проходы до полной сортировки
...
-  Выбирает опорный элемент (pivot) и разбивает массив на две части: элементы меньше pivot и элементы больше pivot, затем рекурсивно сортирует обе части
...
- Строит двоичную кучу (heap) из массива, затем многократно извлекает максимальный элемент из кучи и помещает в конец массива
